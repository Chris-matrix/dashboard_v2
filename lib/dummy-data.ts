...
export const generateFollowerGrowthData = (months = 12) => {
  ...
  for (let i = months; i >= 0; i--) {
    ...
    // Base values
    let instagram = i === months ? 50000 : data[0].instagram;
    let twitter = i === months ? 25000 : data[0].twitter;
    let facebook = i === months ? 12000 : data[0].facebook;
    let linkedin = i === months ? 5000 : data[0].linkedin;
